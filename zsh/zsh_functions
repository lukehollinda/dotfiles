...
# Useful little function to grab the value for key $1, from a yaml input
yqget () {
...
# Capture the output of a command, to be retrieved with ret
...
# Return the output of the most recent command captured by cap
